  ...
  return (
    <div className="bg-gray-50 h-full w-full">
      <div className="min-h-screen h-full w-screen items-center flex flex-col">
        ...
        <div className="flex flex-col mt-5 md:mt-13 h-full w-6/7 md:w-4/5 2xl:w-13/20 mb-20">
          {loading && <Loader />}
          {!loading && (
            <>
              <div className="w-full flex flex-col gap-10 md:gap-20 space-y-8">
                {services.map((obj, idx) => (
                  <ScrollAnimation from="x" distance={idx % 2 !== 0 ? -50 : 50}>
                    <div
                      key={idx}
                    ...
                    >
                      <div className="text-gray-700 flex items-center justify-center">
                        <div className="bg-gray-white outline-2 outline-gray-300 pb-4 md:w-150 gap-4 rounded-2xl flex flex-col text-center md:text-left">
                          <span className="px-5 py-4 border-b-6 border-orange-400 rounded-t-2xl text-2xl 2xl:text-[26px] font-semibold">
                            {obj.name}
                          </span>
                      ...
                      <div className="w-60 md:w-68 2xl:w-74 aspect-[4/5] overflow-hidden rounded-xl shadow-xl">
