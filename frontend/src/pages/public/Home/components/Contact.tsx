...
export default function Contact() {
  ...
  return (
    <div className="w-7/8 md:w-2/5 h-125 flex gap-3 justify-self-center overflow-hidden rounded-2xl bg-neutral-950">
      <div className="flex flex-col items-center w-full h-full gap-10 px-4 py-10 md:px-10 text-white">
        <div>
          <h4 className="font-semibold text-xl text-center md:text-2xl">ENTRE EM CONTATO CONOSCO</h4>
        </div>
