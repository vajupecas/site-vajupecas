            ...
            >
              {producers.map((obj) => (
                <motion.button
                  ...
                  className="flex shadow-md bg-white cursor-pointer select-none outline-1 outline-gray-400 rounded-lg items-center justify-center min-w-fit w-50 md:w-60 2xl:w-75 h-25 md:h-35 2xl:h-45"
                >
