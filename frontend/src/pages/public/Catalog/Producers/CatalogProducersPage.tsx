      ...
      <div className="min-h-screen w-screen items-center flex flex-col overflow-x-hidden">
        ...
        <div className="flex flex-col mt-5 h-full w-4/5 md:w-3/4 items-center">
          <div className="w-full flex flex-col gap-3 md:gap-5">
            ...
            <h2 className="text-gray-700 text-2xl md:text-5xl font-medium">
              Selecione o{" "}
          ...
          {!loading && (
            <div
              className={`md:w-2/3 mt-10 mb-20 md:0 md:mt-15 flex flex-col md:grid gap-6 ${
            ...
            >
              {producers.map((obj) => (
                <motion.button
                  ...
                  className="flex bg-white cursor-pointer select-none outline-1 outline-gray-400 rounded-lg items-center justify-center min-w-fit w-50 md:w-75 h-25 md:h-45"
                >
                  <h4 className="text-gray-700 text-xl md:text-3xl font-medium px-2">{obj.name}</h4>
                </motion.button>
              ))}
            </div>
          )}
