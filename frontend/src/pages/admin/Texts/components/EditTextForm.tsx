        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              name="textContent"
              id="textContent"
              className="block w-full lg:h-40 xl:h-70 rounded-md bg-gray-50 px-3 py-1.5 text-base text-gray-700 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-white0 focus:outline-2 focus:-outline-offset-2 focus:outline-orange-600 00 sm:text-sm/6"
